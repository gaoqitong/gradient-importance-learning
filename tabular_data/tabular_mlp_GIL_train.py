...
if __name__ == '__main__':
    ...
    file_appendix = "Ophthalmic_35_missing_MLP_GIL_" + str(start_learning_rate) + "_" + str(decay_step) + "_" + str(decay_rate) + "_" + str(actor_lr) + "_" + str(critic_lr)
    ...
    with tf.Session(config=session_config, graph=graph) as sess:
        ...
        with open("./stats/Ophthalmic_35_missing_GIL.txt", "a") as myfile:
