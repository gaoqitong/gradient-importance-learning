...
if __name__ == '__main__':
    ...
    file_appendix = "MIMIC_LSTM_GIL-D_" + str(start_learning_rate) + "_" + str(decay_step) + "_" + str(decay_rate) + "_" + str(num_hidden) + "_" + str(actor_lr) + "_" + str(critic_lr)
    ...
    with tf.Session(config=session_config, graph=graph) as sess:
        ...
        with open("./stats/MIMIC_LSTM_GIL-D.txt", "a") as myfile:
